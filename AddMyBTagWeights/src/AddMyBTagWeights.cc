...
AddMyBTagWeights::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   ...
   edm::LogInfo   ("weights")<<"addBTagWeights bTag event weights ";
   ...
   // calculating probabilities
	...
	edm::LogInfo   ("weights")<<"btagWeights[0] "<<btagWeights[0]<<" btagWeights[1] "<<btagWeights[1]<< "  btagWeights[2] "<<btagWeights[2]<<" btagWeights[3] " <<btagWeights[3] << " btagWeights[4] "<<btagWeights[4];
